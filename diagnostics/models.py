...
class DiagnosticImage(models.Model):
    farmer = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='diagnostic_images')
    plant = models.ForeignKey('farms.PlantInstance', on_delete=models.SET_NULL, null=True, blank=True)
...
class DiagnosisResult(models.Model):
    diagnostic_image = models.OneToOneField(DiagnosticImage, on_delete=models.CASCADE, related_name='result')
